return {
    descriptions={
        Back={
            ...
            b_ghost={
                ...
                text={
                    ...
                    "appear in the shop,",
                    "start with a {C:spectral,T:c_hex}Lucky Marble{} card",
                },
            },
            b_green={
                name="Dandori Deck",
        ...
        Joker={
            j_8_ball={
                ...
                text={
                    ...
                    "{C:tarot}Ship Part{} card when scored",
            ...
            j_cartomancer={
                name="Spherical Atlas",
                text={
                    "Create a {C:tarot}Ship Part{} card",
                    "when {C:attention}Blind{} is selected",
                    "{C:inactive}(Must have room)",
                },
                unlock={
                    "Discover every",
                    "{E:1,C:tarot}Ship Part{} card",
                },
            },
            j_castle={
            ...
            j_constellation={
                ...
                text={
                    ...
                    "a {C:planet}Pikmin{} card is used",
                    "{C:inactive}(Currently {X:mult,C:white} X#2# {C:inactive} Mult)",
                },
            },
            j_crafty={
                name="Fiery Young Yellow Wollyhop",
                text={
                    "{C:chips}+#1#{} Chips if played",
                    "hand contains",
                    "a {C:attention}#2#",
            ...
            j_credit_card={
                name="All-Devouring Black Hole Loan Sharks",
                text={
                    "Go up to",
                    "{C:red}-$#1#{} in debt",
                },
            ...
            j_fortune_teller={
                name="S.S. Dolphin",
                text={
                    "{C:red}+#1#{} Mult per {C:purple}Ship Part{}",
                    "card used this run",
            ...
            j_hallucination={
                ...
                text={
                    ...
                    "a {C:tarot}Ship Part{} card when any",
            ...
            j_ring_master={
                name="Juicy Gaggle",
                text={
                    "{C:attention}Joker{}, {C:tarot}Ship Part{}, {C:planet}Pikmin{},",
            ...
            j_satellite={
                ...
                text={
                    ...
                    "round per unique {C:planet}Pikmin",
                    "card used this run",
                    "{C:inactive}(Currently {C:money}$#2#{C:inactive})",
                },
                unlock={
            ...
            j_superposition={
                name="Puffy Blowhog",
                text={
                    "Create a {C:tarot}Ship Part{} card if",
            ...
            j_vagabond={
                name="Emergence Cave",
                text={
                    "Create a {C:purple}Ship Part{} card",
                    "if hand is played",
                    "with {C:money}$#1#{} or less",
                },
            },
            j_vampire={
                name="Withering Blowhog",
                text={
                    "This Joker gains {X:mult,C:white} X#1# {} Mult",
        ...
        Other={
            ...
            blue_seal={
                name="Blue Seal",
                text={
                    "Creates the {C:planet}Pikmin{} card",
            ...
            purple_seal={
                name="Purple Seal",
                text={
                    "Creates a {C:tarot}Ship Part{} card",
        ...
        Tarot={
            ...
            c_emperor={
                ...
                text={
                    ...
                    "random {C:tarot}Ship Part{} cards",
                    "{C:inactive}(Must have room)",
                },
            },
            c_empress={
                name="Eternal Fuel Dynamo",
                text={
            ...
            c_fool={
                ...
                text={
                    "Creates the last",
                    "{C:tarot}Ship Part{} or {C:planet}Pikmin{} card",
                    "used during this run",
                    "{s:0.8,C:tarot}Whimsical Radar{s:0.8} excluded",
                },
            },
            c_hanged_man={
                name="Nova Blaster",
        ...
        Voucher={
            ...
            v_observatory={
                name="Olimar's Comeback",
                text={
                    "{C:planet}Pikmin{} cards in your",
            ...
            v_planet_tycoon={
                ...
                unlock={
                    "Buy a total of",
                    "{C:attention}#1#{C:planet} Pikmin{} cards",
                    "from the shop",
                    "{C:inactive}(#2#)",
                },
            },
            ...
            v_tarot_merchant={
                ...
                text={
                    "{C:tarot}Ship Part{} cards appear",
                    "{C:attention}#1#X{} more frequently",
                    "in the shop",
                },
            },
            v_tarot_tycoon={
                ...
                unlock={
                    "Buy a total of",
                    "{C:attention}#1#{C:tarot} Ship Part{} cards",
                    "from the shop",
                    "{C:inactive}(#2#)",
                },
            },
    ...
    misc={
        achievement_descriptions={
            ...
            astronomy="Discover every Pikmin card",
            ...
            cartomancy="Discover every Ship Part card",
        ...
        challenge_names={
            c_blast_off_1="Pikmin Propagation",
            c_bram_poker_1="Running on Fumes",
            c_city_1="Brazier to Brazier",
            c_cruelty_1="Thirsty Desert",
            c_double_nothing_1="Shearfleas",
            c_five_card_1="Five-Petal Feat",
            c_fragile_1="Crystal Nodules",
            c_golden_needle_1="Joustmite Jaunt",
            c_inflation_1="Hocotate Debt",
            c_jokerless_1="Pure Dandori",
            c_knife_1="Waddlequaff's Feast",
            c_luxury_1="Full Hull",
            c_mad_world_1="Bop That Beetle!",
            c_medusa_1="Rock Onion",
            c_monolith_1="Evasion Expert",
            c_non_perishable_1="Eternal Emerald Eye",
            c_omelette_1="Hideous Victual",
            c_rich_1="Sparklium Engine",
            c_typecast_1="Serene Shores at Noon",
            c_xray_1="Buried Treasure",
        },
        collabs={
            Clubs={
                ["1"]="Default",
        ...
        dictionary={
            ...
            b_stat_planets="Pikmin",
            b_stat_spectrals="Spectrals",
            b_stat_tarots="Ship Parts",
            b_stat_vouchers="Vouchers",
            b_stats="Stats",
            b_tags="Tags",
            b_tarot_cards="Ship Part Cards",
            ...
            k_plus_planet="+1 Pikmin",
            k_plus_spectral="+1 Spectral",
            k_plus_stone="+1 Stone",
            k_plus_tarot="+1 Ship Part",
            ...
            ph_mr_bones="Saved by Ice Blast",
